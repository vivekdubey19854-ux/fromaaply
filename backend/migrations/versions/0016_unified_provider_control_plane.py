...
def upgrade() -> None:
    ...
    for provider, name, methods in (("firebase", "Firebase Authentication", ["password", "google", "phone_otp"]), ("supabase", "Supabase Auth", ["password", "google", "phone_otp"]), ("clerk", "Clerk", ["password", "google", "phone_otp"]), ("stytch", "Stytch", ["password", "google", "phone_otp"]), ("descope", "Descope", ["password", "google", "phone_otp"])):
